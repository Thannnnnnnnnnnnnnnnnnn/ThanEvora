...
$sql_approved_count = "SELECT COUNT(*) AS approved_count FROM `2222` WHERE Status = 'Approved'";
...
$sql_rejected_count = "SELECT COUNT(*) AS rejected_count FROM `2222` WHERE Status = 'Rejected'";
...
$sql_pending_count = "SELECT COUNT(*) AS pending_count FROM `2222` WHERE Status = 'Pending'";
...
$sql_two_wheel_count = "SELECT COUNT(*) AS two_wheel_count FROM `2222` WHERE Vehicle_type = '2 Wheel'";
...
$sql_four_wheel_count = "SELECT COUNT(*) AS four_wheel_count FROM `2222` WHERE Vehicle_type = '4 Wheel'";
...
$sql_vehicle_count = "SELECT COUNT(*) AS vehicle_count FROM `2222`";
...
$sql_admin_count = "SELECT COUNT(*) AS admin_count FROM `adi` WHERE account_type = '1'";
...
$sql_user_count = "SELECT COUNT(*) AS user_count FROM `adi` WHERE account_type = '2'";
...
$sql_recent_reservations = "SELECT * FROM `2222`";
...
$sql_brand_counts = "SELECT Vehicle_brand, COUNT(*) AS brand_count FROM `2222` GROUP BY Vehicle_brand";
...
$sql_reservation_day_count = "SELECT DAYNAME(Date) AS day, COUNT(*) AS reservations_per_day FROM `2222` GROUP BY DAYNAME(Date)";
...
$query = "SELECT * FROM `2222` ORDER BY Status DESC, Date DESC, Time DESC"; 
