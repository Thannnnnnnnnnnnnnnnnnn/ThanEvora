...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_2222 = "INSERT INTO `2222` (Vehicle_type, Vehicle_color, Vehicle_brand, Plate_no, Date, Time, Status, Plate_image) 
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $connections->prepare($sql_2222);
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
    ...
    <div style="display: flex; align-items: center;">
        ...
        <img id="preview" src="#" alt="Preview Image" style="display: none; max-width: 200px; margin-left: 10px;">
    </div>
</div>
