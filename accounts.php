...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `adi` (tbl_id, Email, password, account_type, Contact_No, Firstname, Lastname) VALUES ('$tbl_id', '$Email', '$password', '$account_type', '$Contact_No', '$Firstname', '$Lastname')";
