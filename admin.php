...
$query = "SELECT * FROM `2222` ORDER BY Date DESC, Time DESC"; 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_2222 = "INSERT INTO `2222` (Vehicle_type, Vehicle_color, Vehicle_brand, Plate_no, Date, Time, Status) VALUES ('$Vehicle_type', '$Vehicle_color', '$Vehicle_brand','$Plate_no', '$Date','$Time', '$Status')";

    // Insert data into the `history` table
    $sql_history = "INSERT INTO `history` (Vehicle_type, Vehicle_color, Vehicle_brand, Plate_no, Date, Time) VALUES ('$Vehicle_type', '$Vehicle_color', '$Vehicle_brand','$Plate_no', '$Date','$Time')";

    // Execute both queries and check for success
    if ($connections->query($sql_2222) === TRUE && $connections->query($sql_history) === TRUE) {
